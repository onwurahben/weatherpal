...
//This class presents users two ways to retrieve weather forecasts, using their current location and using any city name.
...
class ForecastModel {
  ...
  String getForecastMessage(int temp) {
    if (temp > 25) {
      return 'It\'s 🍦 time';
    } else if (temp > 20) {
